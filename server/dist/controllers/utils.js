...
exports.error = exports.ok = exports.toDto = void 0;
var class_transformer_1 = require("class-transformer");
var class_validator_1 = require("class-validator");
function toDto(request, type) {
    return __awaiter(this, void 0, void 0, function () {
        var user, errors;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    user = (0, class_transformer_1.plainToClass)(type, request.body);
...
exports.ok = ok;
function error(info) {
    return __assign({ status: 'error' }, info && { info: info });
}
exports.error = error;
